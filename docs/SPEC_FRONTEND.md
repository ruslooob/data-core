...
Виджет = независимое окно с графиком / панелью. Размещение на экране — вертикальный стек, новые виджеты добавляются снизу. Плавающие окна на полотне — в будущем.
...
- Несколько price chart виджетов синхронизируются по оси X (время) — зум/скролл одного двигает остальные
...
- Плавающие окна на полотне (drag-and-drop, resize)
- Dashboard-сетка с перетаскиваемыми плитками
- Авторизация
